...
class KnowledgeGraph:
    ...
    def promote_pair(
        ...
        *,
        ...
        # ── EN extraction: noun chunks + content-lemma 2/3-grams ──────
        en_phrases: List[str] = []
        seen_en: set = set()
        ...
        # ── SL extraction: classla/stanza dependency phrases ──────────
        ...
        # min_freq filtering that a bulk seeder earns over thousands of
